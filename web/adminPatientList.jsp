...
<html>
    <head>
        ...
        <title>Patient List | Medico</title>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><% out.print(zipcode); %></td>
                                <td>				
                                    <a href="adminDeletePatient.jsp?p_id=<%= p_id %>"><i class="fa fa-trash-o" style="font-size:30px; color: red;"></i></a>
                                </td>
                            </tr>
                            <%
                                }
